...
from lasso_daily_factor_model import rolling_lasso_prediction


class TestLassoDailyFactorModel(unittest.TestCase):
    ...
    def test_rolling_lasso_runs(self):
        """
        Test model runs
        """
        pred, coef = rolling_lasso_prediction(
            self.df,
            self.factor_cols,
            window_days=50,
            alpha=0.001
    ...
    def test_prediction_column_exists(self):
        ...
        """
        pred, _ = rolling_lasso_prediction(
            self.df,
            self.factor_cols,
            window_days=50,
            alpha=0.001
        ...
        self.assertIn("pred_ret_lasso", pred.columns)
    ...
    def test_prediction_not_all_nan(self):
        ...
        self.assertTrue(pred["pred_ret_lasso"].notna().sum() > 0)
    ...
    def test_coef_output(self):
        ...
        """
        _, coef = rolling_lasso_prediction(
            self.df,
            self.factor_cols,
            window_days=50,
            alpha=0.001
